 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.ExternalUseImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalUseImpl extends ExpressionImpl implements ExternalUse
{
  ...
  public EList<Expression> getExp()
  {
    if (exp == null)
    {
      exp = new EObjectContainmentEList<Expression>(Expression.class, this, MathPackage.EXTERNAL_USE__EXP);
    }
    return exp;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MathPackage.EXTERNAL_USE__EXP:
